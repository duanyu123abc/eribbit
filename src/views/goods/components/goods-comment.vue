<template>
  <div class="goods-comment">
    ...
    <!-- 分页组件 -->
    <XtxPagination v-if="total" @current-page="changePagerFn" :total="total" :page-size="reqParams.pageSize" :current-page="reqParams.page"></XtxPagination>
  </div>
</template>
...
export default {
  ...
  setup () {
    ...
    findGoodsCommentInfo(goods.value.id).then(data => {
      // 在设置数据之前，tags数组前追加有图tag 全部评价tag
